...
async function getCandidateProfileHandler(req, res) {
  try {
    ...
    const defaultProfile = {
      ...
      bio: 'High-velocity Full Stack & AI Systems Engineer with 4+ years of experience architecting resilient Node.js backends, modern React dashboards, and Enterprise GenAI integrations.',
      skills: ['JavaScript', 'TypeScript', 'React.js', 'Node.js', 'PostgreSQL', 'Docker', 'GraphQL', 'Tailwind CSS', 'AWS', 'Prisma'],
      experienceYears: 4,
...
const CURATED_JOB_LISTINGS = [
  ...
  },
  {
    ...
    skills: ['Python', 'PyTorch', 'Hugging Face', 'LangChain', 'Vector DBs', 'FastAPI'],
    postedAgo: '1 day ago',
    applicantsCount: 68,
    matchScore: 88
  },
