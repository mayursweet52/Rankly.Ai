...
async function sendTestEmail(req, res) {
    try {
        ...
        const targetEmail = req.body?.email || req.user?.email || req.user?.workEmail || req.session?.user?.email || req.session?.user?.workEmail || process.env.DEVELOPER_EMAIL || 'rankly.ai.com@gmail.com';
