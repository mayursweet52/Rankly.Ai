...
## Corpus Check
- 205 files · ~486,559 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1321 nodes · 1743 edges · 157 communities (87 shown, 58 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 202 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c8e742e5`
...
Cohesion: 0.05
Nodes (58): bcrypt, companyResetPassword(), crypto, failAuth(), forgotPassword(), formatUserResponse(), { generateOtp, generateReferralCode }, getAppBaseUrl() (+50 more)
...
Cohesion: 0.10
Nodes (25): authLimiter, authController, { authLimiter, authBackoffLimiter }, axios, bcrypt, crypto, express, { isAuthenticated } (+17 more)
...
Cohesion: 0.18
Nodes (11): batchUploadHandler(), detectRoleHandler(), { extractTextFromDocument, extractCandidateInfoFromText }, fs, prisma, { screenResume, detectRole }, screenResumeHandler(), detectRole() (+3 more)

### Community 12 - "auth.js"
Cohesion: 0.15
Nodes (14): prisma, requireHRMS(), requireRole(), verifyToken, employeeController, express, { isAuthenticated, requireHRMS, requireRole }, { publicLimiter } (+6 more)
...
Cohesion: 0.15
Nodes (12): isAuthenticated(), authorizeRoles(), { authorizeRoles }, express, { isAuthenticated }, router, { supabase }, { authorizeRoles } (+4 more)
...
Cohesion: 0.14
Nodes (14): ollama, { chatCareerCounselor }, prisma, sendMessage(), axios, chatCareerCounselor(), { evaluateResumeRuleBased, safeJsonParse }, executeAiInference() (+6 more)
...
Cohesion: 0.17
Nodes (6): pg, { pool }, tables, db, db, { Pool }
...
### Community 31 - "test-e2e-ai-pipeline.js"
Cohesion: 0.25
...
### Community 42 - "skillMarketplaceRoutes.js"
Cohesion: 0.29
Nodes (6): publicLimiter, express, { optionalAuth }, { publicLimiter }, router, skillMarketplaceController
...
Cohesion: 0.14
Nodes (13): optionalAuth(), aiLimiter, aiAgentController, express, { optionalAuth }, { publicLimiter, aiLimiter }, router, { aiLimiter } (+5 more)
...
### Community 52 - "express"
Cohesion: 0.33
Nodes (5): express, appService, express, { isAuthenticated }, router

### Community 53 - "bcryptjs"
Cohesion: 0.40
Nodes (4): bcrypt, mongoose, UserSchema, bcryptjs

### Community 54 - "capture_candidate_shots.js"
Cohesion: 0.40
Nodes (3): axios, path, puppeteer

### Community 55 - "capture_screenshots.js"
Cohesion: 0.40
Nodes (3): axios, path, puppeteer
...
### Community 103 - "analyticsRoutes.js"
Cohesion: 0.25
...
Cohesion: 0.50
Nodes (3): crypto, mammoth, pdfParseModule

## Knowledge Gaps
- **677 isolated node(s):** `@magicuidesign/mcp`, `@nexus2520/figma-mcp-server`, `figma-developer-mcp`, `SidebarToggleIconProps`, `mongoose` (+672 more)
...
- **Why does `axios` connect `axios` to `test_authenticated_browser.js`, `database.js`, `documentController.js`, `test-complaints.js`, `authRoutes.js`, `package.json`, `aiService.js`, `capture_screenshots.js`, `puppeteer-core`, `capture_candidate_shots.js`, `test-integration.js`, `test-e2e-ai-pipeline.js`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `express` connect `express` to `exportRoutes.js`, `server.js`, `services/healthChecker.js`, `userRoutes.js`, `documentRoutes.js`, `analyticsRoutes.js`, `authRoutes.js`, `package.json`, `attendanceRoutes.js`, `auth.js`, `candidateRoutes.js`, `resumeRoutes.js`, `jwtEmployeeRoutes.js`, `leaveRoutes.js`, `skillMarketplaceRoutes.js`, `pgEmployeeRoutes.js`?**
